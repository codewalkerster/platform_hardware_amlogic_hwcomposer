...
public:
    ...
    virtual void disableQms(bool isDisable);
    ...
    virtual hwc2_error_t getCurrentSupportDeepColor(std::string& color);
...
public:
    ...
    virtual int32_t blankDisplayLocked(bool blockMode = true);
